...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      // Log: LoginScreen - handleLogin - Sending login request
      ...
      // Log: LoginScreen - handleLogin - Login response received
      ...
      // Log: LoginScreen - handleLogin - Error occurred during login
